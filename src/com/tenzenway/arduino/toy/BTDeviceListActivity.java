...
public class BTDeviceListActivity extends Activity {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				if (_newDevicesArrayAdapter.getCount() == 0) {
					_newDevicesArrayAdapter.add(getResources().getText(
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		_pairedDevicesArrayAdapter = new ArrayAdapter<String>(this,
				R.layout.device_name);
		_newDevicesArrayAdapter = new ArrayAdapter<String>(this,
				R.layout.device_name);
		...
		// Register for broadcasts when a device is discovered & discovery has
		// finished
		this.registerReceiver(_receiver, new IntentFilter(
		...
		if (pairedDevices.size() > 0) {
			...
			_pairedDevicesArrayAdapter.add(getResources().getText(
